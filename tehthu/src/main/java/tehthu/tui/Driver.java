...
public class Driver {
	...
	public static void main(String[] args) {
		...
		String leftLang = p.getDictionary().getLeftLangName(),
				rightLang = p.getDictionary().getRightLangName();
		Direction dir = null;
		while(true) {
			...
			System.out.println("Enter a sentence in " + (dir == Direction.LTR ? leftLang : rightLang) + " to be translated into " + (dir == Direction.LTR ? rightLang : leftLang));
